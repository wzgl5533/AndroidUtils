...
public final class ToastUtils {
    ...
    public static void normalShort(@NonNull CharSequence message) {
        setMsgColor(DEFAULT_TEXT_COLOR);
        showShort(message);
    }

    public static void normalLong(@NonNull CharSequence message) {
        setMsgColor(DEFAULT_TEXT_COLOR);
        showLong(message);
    }

    public static void warningShort(@NonNull CharSequence message) {
    ...
    public static void warningLong(@NonNull CharSequence message) {
    ...
    public static void infoShort(@NonNull CharSequence message) {
    ...
    public static void infoLong(@NonNull CharSequence message) {
    ...
    public static void successShort(@NonNull CharSequence message) {
    ...
    public static void successLong(@NonNull CharSequence message) {
    ...
    public static void errorShort(@NonNull CharSequence message) {
    ...
    public static void errorLong(@NonNull CharSequence message) {
